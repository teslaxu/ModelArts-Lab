...
* bochuan007:1个积分，贡献点：
    * 完成案例：[第二期](https://github.com/huaweicloud/ModelArts-Lab/issues/113#issuecomment-504643500)
    * 体验文章：
    * 扩展案例：
    * 实际应用案例：
...
* youzidata: 1个积分，贡献点：
    * 完成案例：[第一期](https://github.com/huaweicloud/ModelArts-Lab/issues/49#issuecomment-504735100)
    * 体验文章：
    * 扩展案例：
    * 实际应用案例：
